...
--You need to get the unique code (four numbers and three letters usually but sometimes different) for the keyboard with name "MACROS"
...
print ('Minimise to hide this window and continue');
...
sendToAHK = function (key)
      ...
      local file = io.open(home .."\\Dropbox\\Documents\\AHK Scripts\\Smart-Global-play\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
...
--This section allows us to use a sound monitoring script for the play key without blocking the use of other keys such as volume controls.
PlayscriptAHK = function (key)
      --print('It was assigned string:    ' .. key)
      local file = io.open(home .."\\Dropbox\\Documents\\AHK Scripts\\Smart-Global-play\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
      --Make sure to substitute the path that leads to your own "keypressed.txt" file, using the double backslashes.
	  --print("we are inside the text file")
      ...
      file:flush() --"flush" means "save"
      file:close()
      print("sent play to f23")
      lmc_send_keys('{F23}')  -- This presses F23. Using the F23 key to trigger AutoHotKey is probably NOT the best method. Feel free to program something better!
end
